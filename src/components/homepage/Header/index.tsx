...
const Header = () => {
  return (
    <header
      ...
      style={{
        background: "linear-gradient(180deg, #DBDBDB 0%, #DCDCDC 45%, #DCDCDC 100%)",
      }}
    >
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        >
          <div className="relative h-full w-full min-h-[448px] md:min-h-[428px]">
            <Image
              priority
              src="/images/header-res-homepage.jpeg"
              alt="Stylish man wearing a suit"
              fill
              sizes="(max-width: 767px) 100vw, 0vw"
              className="block md:hidden object-contain pointer-events-none select-none"
            />
            <Image
              priority
              src="/images/header-homepage.jpeg"
              alt="Stylish man wearing a suit"
              fill
              sizes="(max-width: 767px) 0vw, 50vw"
              className="hidden md:block object-contain pointer-events-none select-none"
            />
          </div>
          <Image
            priority
            ...
            width={104}
            alt="big star"
            className="absolute right-7 xl:right-0 top-12 max-w-[76px] max-h-[76px] lg:max-w-24 lg:max-h-max-w-24 xl:max-w-[104px] xl:max-h-[104px] animate-[spin_4s_infinite] z-10"
          />
          <Image
            priority
